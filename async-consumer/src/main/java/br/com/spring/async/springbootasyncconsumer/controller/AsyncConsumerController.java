...
public class AsyncConsumerController {
    ...
    public ResponseEntity<?> findUsers() throws Throwable {
		...
		// Múltiplos Lookups
		CompletableFuture<User> user1 = asyncConsumerService.findUser("edveloso");
		CompletableFuture<User> user2 = asyncConsumerService.findUser("rafafittipaldi");
		CompletableFuture<User> user3 = asyncConsumerService.findUser("alonsolucas");
		CompletableFuture<User> user4 = asyncConsumerService.findUser("tulioov");
